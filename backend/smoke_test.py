...
def main() -> int:
    ...
    ok(
        ...
        any(v in pubspec for v in ("1.0.0+3", "1.0.0+4", "1.0.0+5", "1.0.0+6", "1.0.0+7", "1.0.0+8"))
        and any(v in settings_ce for v in ("1.0.0+3", "1.0.0+4", "1.0.0+5", "1.0.0+6", "1.0.0+7", "1.0.0+8"))
        and "VERSION.txt" in pack_bat
        and any(v in pack_bat for v in ("1.0.0+3", "1.0.0+4", "1.0.0+5", "1.0.0+6", "1.0.0+7", "1.0.0+8")),
        "pubspec/Sobre/bat +3..+8",
    )
    ...
    if ver_txt.exists():
        ...
        ok(
            ...
            any(v in _ver_ce for v in ("1.0.0+3", "1.0.0+4", "1.0.0+5", "1.0.0+6", "1.0.0+7", "1.0.0+8")),
            str(ver_txt),
        )
    else:
    ...
    ok(
        ...
        ("1.0.0+4" in pubspec or "1.0.0+5" in pubspec or "1.0.0+6" in pubspec or "1.0.0+7" in pubspec or "1.0.0+8" in pubspec)
        and ("1.0.0+4" in settings_ck or "1.0.0+5" in settings_ck or "1.0.0+6" in settings_ck or "1.0.0+7" in settings_ck or "1.0.0+8" in settings_ck)
        and ("1.0.0+4" in pack_bat or "1.0.0+5" in pack_bat or "1.0.0+6" in pack_bat or "1.0.0+7" in pack_bat or "1.0.0+8" in pack_bat),
        "version +4/+5/+6",
    )
    ...
    if ver_cl.exists():
        ...
        ok(
            ...
            any(v in _ver_cl for v in ("1.0.0+4", "1.0.0+5", "1.0.0+6", "1.0.0+7", "1.0.0+8")),
            str(ver_cl),
        )
    else:
    ...
    ok(
        ...
        any(v in pubspec for v in ("1.0.0+5", "1.0.0+6", "1.0.0+7", "1.0.0+8"))
        and any(v in settings_ck for v in ("1.0.0+5", "1.0.0+6", "1.0.0+7", "1.0.0+8"))
        and any(v in pack_bat for v in ("1.0.0+5", "1.0.0+6", "1.0.0+7", "1.0.0+8")),
        "version +5/+6",
    )
    ...
    if ver_cp.exists():
        ...
        ok(
            ...
            "1.0.0+5" in _ver_cp or "1.0.0+6" in _ver_cp or "1.0.0+7" in _ver_cp or "1.0.0+8" in _ver_cp,
            str(ver_cp),
        )
    else:
    ...
    ok(
        ...
        any(v in pubspec for v in ("1.0.0+6", "1.0.0+7", "1.0.0+8"))
        and any(v in settings_ck for v in ("1.0.0+6", "1.0.0+7", "1.0.0+8"))
        and any(v in pack_bat for v in ("1.0.0+6", "1.0.0+7", "1.0.0+8")),
        "version +6/+7/+8",
    )
    ...
    if ver_ct.exists():
        ok(
            ...
            any(v in ver_ct.read_text(encoding="utf-8", errors="ignore") for v in ("1.0.0+6", "1.0.0+7", "1.0.0+8")),
            str(ver_ct),
        )
    else:
    ...
    ok(
        ...
        any(v in pubspec for v in ("1.0.0+7", "1.0.0+8"))
        and any(v in settings_ck for v in ("1.0.0+7", "1.0.0+8"))
        and any(v in pack_bat for v in ("1.0.0+7", "1.0.0+8")),
        "version +7/+8",
    )
    ...
    if ver_cu.exists():
        ok(
            ...
            any(v in ver_cu.read_text(encoding="utf-8", errors="ignore") for v in ("1.0.0+7", "1.0.0+8")),
            str(ver_cu),
        )
    else:
    ...
    ok(
        ...
        "1.0.0+8" in pubspec and "1.0.0+8" in settings_ck and "1.0.0+8" in pack_bat,
        "version +8",
    )
    ...
    if ver_cv.exists():
        ok(
            ...
            "1.0.0+8" in ver_cv.read_text(encoding="utf-8", errors="ignore"),
            str(ver_cv),
        )
    else:
