                        ...
                        children: [
                          Expanded(
                            child: SelectableText(
                              ...
                              style: TextStyle(fontSize: 13, color: cs.onSurface.withOpacity(0.7)).copyWith(color: cs.tertiary),
                            ),
                          ),
                        ],
                      ),
                  ...
                  Material(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(fontSize: 13, color: cs.onSurface.withOpacity(0.7)).copyWith(color: cs.onPrimaryContainer),
                      ),
                    ),
                  ),
                Expanded(
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(pair['message']?.toString() ?? '', style: TextStyle(fontSize: 13, color: cs.onSurface.withOpacity(0.7))),
                            if (unmatchedQ.isNotEmpty)
                              Text(
                                'Sem gabarito: ${unmatchedQ.take(12).join(', ')}${unmatchedQ.length > 12 ? '…' : ''}',
                                style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: cs.onSurface).copyWith(color: cs.onTertiaryContainer),
                              ),
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      SelectableText(
                        ...
                        style: TextStyle(fontSize: 13, color: cs.onSurface.withOpacity(0.7)).copyWith(
