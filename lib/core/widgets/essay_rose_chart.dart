                ...
                RadarChartData(
                  dataSets: [
                    RadarDataSet(
                      ...
                      fillColor: cs.primary.withOpacity(0.30),
                  ...
                  radarBorderData: BorderSide(color: cs.outlineVariant.withOpacity(0.7)),
                  tickBorderData: BorderSide(color: cs.outlineVariant.withOpacity(0.35)),
                  gridBorderData: BorderSide(color: cs.outlineVariant.withOpacity(0.55)),
                  ticksTextStyle: TextStyle(fontSize: 10, color: cs.onSurface.withOpacity(0.35)),
                  tickCount: 5,
